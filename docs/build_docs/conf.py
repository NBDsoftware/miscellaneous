...
htmlhelp_basename = 'miscellaneoushelp'
...
latex_documents = [
    (master_doc, 'miscellaneous.tex', 'miscellaneous documentation',
...
man_pages = [
    (master_doc, 'miscellaneous', 'miscellaneous documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'miscellaneous', 'miscellaneous documentation',
     author, 'miscellaneous', 'miscellaneous of python scripts for drug discovery',
     'Miscellaneous'),
]
